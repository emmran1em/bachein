  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <Tabs.Screen name="received" options={{ title: 'Received', tabBarIcon: ({ color, size }) => <Ionicons name="mail-outline" size={size} color={color} /> }} />
...
const s = StyleSheet.create({
  fabWrap: { position: 'absolute', bottom: 56, left: 0, right: 0, alignItems: 'center' },
  fab: {
